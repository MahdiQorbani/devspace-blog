  ...
  return (
    <header className="bg-gray-900 text-gray-100 shadow w-full">
      <div className="container mx-auto flex flex-wrap flex-col p-5 md:flex-row items-center">
        <Link
          href="/"
          className="flex md:w-1/5 title-font font-medium items-center md:justify-center mb-4 md:mb-0"
        >
          <Image src="/images/logo.png" width={40} height={40} alt="logo" />
          <span className="ml-3 text-xl">DevSpace</span>
        </Link>
        <nav className="flex flex-wrap md:w-4/5 items-center justify-end textbase md:ml-auto">
          <Link
            href="/blog"
